...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.locationLabel setLineBreakMode:NSLineBreakByTruncatingTail];
...
//    [self.titleLabel autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:self.dateLabel withOffset:0.0f];
...
//    [self.titleLabel autoPinEdgeToSuperviewEdge:ALEdgeTrailing withInset:kLabelHorizontalInsets];
    ...
    [self.locationLabel setContentCompressionResistancePriority:UILayoutPriorityRequired forAxis:UILayoutConstraintAxisVertical];
    [self.locationLabel autoPinEdge:ALEdgeTop toEdge:ALEdgeBottom ofView:self.bodyLabel withOffset:0.0f];
    [self.locationLabel autoPinEdgeToSuperviewEdge:ALEdgeLeading withInset:kLabelHorizontalInsets];
    [self.locationLabel autoPinEdgeToSuperviewEdge:ALEdgeTrailing withInset:kLabelHorizontalInsets];
    [self.locationLabel autoPinEdgeToSuperviewEdge:ALEdgeBottom withInset:kLabelVerticalInsets];
...
- (void)layoutSubviews
{
    ...
    self.locationLabel.preferredMaxLayoutWidth = CGRectGetWidth(self.locationLabel.frame);
}

- (void)updateFonts
{
    self.dateLabel.font = [UIFont systemFontOfSize:16.0f];
    self.bodyLabel.font = [UIFont boldSystemFontOfSize:16.0f];
