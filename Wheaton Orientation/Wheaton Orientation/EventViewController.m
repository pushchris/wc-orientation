...
- (void)viewDidLoad
{
    ...
    ScheduleTableViewController *sVC = [self.storyboard instantiateViewControllerWithIdentifier:@"FreshmenSchedule"];
    ScheduleTableViewController *eVC = [self.storyboard instantiateViewControllerWithIdentifier:@"TransferSchedule"];
    ScheduleTableViewController *aVC = [self.storyboard instantiateViewControllerWithIdentifier:@"ParentSchedule"];
    
    // Add A and B view controllers to the array
    self.allViewControllers = [[NSArray alloc] initWithObjects:sVC, aVC, eVC, nil];
